...
class Sweep_OOPSquare_AFM2_KQ_byteInput(hotspice.experiments.Sweep):
    def __init__(self, groups=None, **kwargs):
        ...
        names = {
            ...
            'moment': "Magnetic moment", 'ext_field': "External field magnitude", 'res_x': "# readout nodes along x-axis", 'res_y': '# readout nodes along y-axis'
        }
...
if __name__ == "__main__":
    ...
    outdir = args.outdir if args.outdir is not None else "KQ_base"
