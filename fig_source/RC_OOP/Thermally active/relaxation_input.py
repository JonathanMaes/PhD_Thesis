...
def plot(data_dir=None):
    ...
    # Setup figure
    figsize = (thesis_utils.page_width, thesis_utils.page_width*.6)
    ...
    fig.subplots_adjust(left=0.16, top=0.85, bottom=0.12, wspace=0.12, hspace=(hspace:=0.3)) #! Already here, because insets require knowledge of final aspect ratio
