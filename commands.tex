...
\newcommand{\indexlabel}[1]{\index{#1}\label{#1}\label{#1s}}
\newcommand{\idx}[1]{\emph{#1}\indexlabel{#1}} %no xspace
\newcommand{\xlabel}[1]{#1\indexlabel{#1}}
