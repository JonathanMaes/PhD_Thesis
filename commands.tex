...
\definecolor{figcolor}{HTML}{EEEEEE}
...
%\newcommand{\class}[1]{\code{\hyperref[code#1]{#1}}} %final version
%\newcommand{\file}[1]{\code{\hyperref[code#1]{#1.java}}} %final version
\newcommand{\class}[1]{\code{#1}\index{#1.java}\xspace}
\newcommand{\file}[1]{\code{#1.java}\index{#1.java}\xspace} %debug version
\newcommand{\hide}[1]{}
...
%\newcommand{\xline}{\includegraphics[width=\textwidth]{line} \\ }
%\renewcommand{\colorbox}[2]{\parbox{\textwidth}{\xline \\ \mbox{#2} \\ \xline}}
...
%5 args: name1,  name2, shortcaption1, shortcaption2, langcaption1+2
...
\colorbox{figcolor}{
	\begin{minipage}{0.94\linewidth}
  		\centering
		\begin{tabular}{cc}
		\small\parbox[c]{0.48\linewidth}{\textsf{\textbf{(a)} #3}} & \small\parbox[c]{0.48\linewidth}{\textsf{\textbf{(b)} #5}}\normalsize\\
