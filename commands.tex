...
%5 args: name1, shortcaption1, name2, shortcaption2, overallcaption
	...
	\begin{tikzpicture}
		\node[rounded corners=10pt, fill=figcolor, inner sep=10pt] (figbox) {
			\begin{minipage}{0.955\linewidth}
				\centering
				\begin{tabular}{cc}
					\small\parbox[c]{0.48\linewidth}{\centering\textsf{\textbf{(a)} #3}} & \small\parbox[c]{0.48\linewidth}{\centering\textsf{\textbf{(b)} #5}}\normalsize\\
