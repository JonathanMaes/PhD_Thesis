...
In the uniform state --- where all magnets collectively point $\uparrow$ --- these will be $\mavg=1$ and $\qNN=0$.
...
\xfig{3_OOP/OOP_relaxation.pdf}{
	...
	The simulations were stopped after \SI{1e4}{\second} and the resulting final magnetic states are shown in the inset, where white (black) indicates up (down) spins.
}
