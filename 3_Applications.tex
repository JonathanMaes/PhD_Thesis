...
Therefore, each experimental datapoint corresponds to some probability density in this simulated distribution.
...
\idx{Bayesian optimisation} (BO) is one such method~\cite{bayesopt_package,BayesOpt_Mockus1975}.
