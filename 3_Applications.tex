...
More extensive parameter searches may benefit from using other optimisation techniques like LIPO~\cite{LIPO,LIPO_dlib}. \\\par % Good explanation in http://blog.dlib.net/2017/12/a-global-optimization-algorithm-worth.html
...
For this reason, the samples were measured soon ($\approx \SI{e3}{\second}$) after initialisation, and again after 2 years $\approx \SI{7e7}{\second}$, providing two sufficiently distinct timescales for a successful fit.
