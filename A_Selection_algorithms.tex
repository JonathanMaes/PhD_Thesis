\chapter{Selection algorithms for Metropolis-Hastings multi-sampling}\label{app:Selection_algorithms}\indexlabel{selection algorithm}\indexlabel[nolabel]{Metropolis-Hastings sampling}\indexlabel[nolabel]{multi-switching}
