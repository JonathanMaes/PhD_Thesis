...
\begin{longtable}[l]{p{60pt} p{350pt}}
	...
	$\Delta \mathcal{N}$ & Difference of demagnetising factors along IP easy and hard axes of a magnet \\
	&\\
	...
	$Q$ & Maximum allowed change in switching probability that two simultaneously sampled magnets can incur on each other \\
	&\\
