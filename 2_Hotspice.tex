...
The probabilities $P_1$ and $P_2$ that a magnet occupies either state then follow directly from the canonical partition function $Z = \exp(\frac{\mu B}{\kBT}) + \exp(\frac{-\mu B}{\kBT})$ as $P_i = \frac{1}{Z} \exp(-\frac{E_i}{\kBT})$.
...
\begin{equation}
	\frac{\langle M \rangle}{M_0} = P_1 - P_2 = \tanh\ab(\frac{\mu B}{\kBT}) \mathrm{,}
\end{equation}
