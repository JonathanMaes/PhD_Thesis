...
Note that hysteresis can not be simulated using \xref{Metropolis-Hastings sampling}, since it ignores the uniaxial anisotropy (i.e., the energy barrier $\EB$) to sample the equilibrium state space.
