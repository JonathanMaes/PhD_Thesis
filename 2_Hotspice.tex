...
\subsubsection{Intrinsic barrier due to \xlabel{shape anisotropy}}
...
Assuming that switching occurs by \xlabel{coherent rotation}\footnote{
	...
	An accurate estimate of the energy barrier for such processes can be determined by e.g. \link{micromagnetic theory}{micromagnetic simulations}.
...
\xfig{2_Hotspice/Hysteresis_Kagome.pdf}{ % TODO FIG: split in two
...
While it is possible to obtain an exact solution for the energy barrier in OOP magnets, the assumption of a sinusoidal energy landscape is likely inaccurate due to non-coherent reversal in real OOP nanomagnets. \par
