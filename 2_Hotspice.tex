...
In many cases, simulations are performed multiple times for statistical averaging or parameter variations.
With the current \hotspice implementation, these simulations must be performed separately.
...
This could particularly enhance GPU performance for small systems.
