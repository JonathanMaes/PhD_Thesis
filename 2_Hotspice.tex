...
\xfig{2_Hotspice/Hysteresis_Pinwheel.pdf}{
	...
	Hysteresis of pinwheel ASI for an \xref{external magnetic field} applied at \ang{30} with respect to the system edges.
...
In-plane kagome ASI (\crefSubFigRef{fig:2:ASIs}{g}) is a typical example of a \xref{frustrated} system: every vertex is formed by three magnets that must obey the two-in/one-out or two-out/one-in ice rule.
...
\sidefig[0.45]{2_Hotspice/Hysteresis_Kagome_EBc.pdf}{
	...
	The effect of a vertically applied \xref{external magnetic field} on a vertical and sloped magnet in kagome ASI, for different values of the energy barrier.
