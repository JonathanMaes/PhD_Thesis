...
% TODO: This can show some interesting things about the energy barrier approximations etc.
This will result in a \xlabel{hysteresis}.
Note that any hysteresis must be simulated using the \xref{first-switch method}, as \xref{Metropolis-Hastings sampling} ignores the uniaxial anisotropy (i.e., the energy barrier $\EB$) and therefore does not yield a representative hysteresis --- if it yields any hysteresis at all.

\subsection{Kagome reversal}
% TODO: This can show some interesting things about the monopole vs. dipole models.

%\subsection{RC by clocking in Pinwheel ASI} % TODO: remove this or not?
%This probably won't be added since it is mostly Ian's work, and concerns RC rather than the simulator itself.

\section{Conclusion}
% TODO END: summarise the main takeaways of all the different sections and subsections.