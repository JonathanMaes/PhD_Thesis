...
\xfig{2_Hotspice/Hysteresis_Kagome.pdf}{
	...
	The magnets have a \xref{magnetic moment} $\mu=\SI{1.1}{\femto\ampere\metre\squared}$, and an \link{shape anisotropy}{energy barrier} $\EB = \SI{120}{\electronvolt} \pm \SI{5}{\percent}$.
