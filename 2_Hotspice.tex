...
Dividing this value by $N$, the number of magnets in the system, gives the number of Monte Carlo sweeps per second (grey curve), which is the main performance metric in MC simulations.
Depending on the specific situation, only some of the selected magnets will in fact switch (yellow curve).
