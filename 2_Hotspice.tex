...
\begin{align*}
	...
	\iff & \EB \sin{2\theta} + \mu B_\mathrm{eff} \sin(\theta - \phi) = 0 \numberthis
\end{align*}
This would require numerical approximation to solve, and is therefore not done in \hotspice for performance reasons. \par
...
Instead, this leads to a quadratic relation as described by \textit{Tannous and Gieraltowski}~\cite{StonerWohlfarth2008}:
\begin{equation}
	\label{eq:2:EB_exact}
	\widetilde{E_\mathrm{B}} = \begin{cases}
