...
\subsubsection{Dumbbell model\indexlabel{dumbbell model}}\label{sec:2:Dumbbell}
...
\subsubsection{Asymmetric barrier}\indexlabel[tosection]{asymmetric energy barrier}\label{sec:2:E_B_asymm}
