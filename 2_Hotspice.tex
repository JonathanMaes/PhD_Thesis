...
\begin{enumerate}
	...
	By default, this is the only interaction considered by \hotspice when an ASI is created.
	...
	This energy contribution provides the primary means for the outside world to interact with the system, and is therefore indispensable for reservoir computing purposes. Even if input is provided through other means than an external field, this energy contribution can often still be used by considering an effective field instead.
