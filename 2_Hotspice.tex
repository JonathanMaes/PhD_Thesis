...
Only the last 3 rows use the \link{unit cell kernel}{magnetostatic kernel} $\vc{\mathcal{K}}^{(\kappa)}$ from~\cref{sec:2:Kernels}; the previous rows use the less efficient kernels considered earlier in that section.
