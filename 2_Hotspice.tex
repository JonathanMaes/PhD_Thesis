...
The grid allows the straightforward implementation of first-order PBC by adjusting these kernels (adding eight offset versions of a kernel to itself), which does not impact performance. % TODO: show in figure?
