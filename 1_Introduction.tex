...
Finally, the separation/approximation property states that distinct signals should yield distinct responses, while similar inputs must be insensitive to noise and thus remain grouped together in the output space~\cite{RC_RecentAdvances}.
