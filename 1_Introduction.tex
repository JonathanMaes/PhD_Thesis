...
More specifically, the total resistance $R(\theta) = R_\perp + (R_\parallel - R_\perp) \cos(2\theta)$. % TODO: same here, should these symbols be in the symbols list? I don't think so.
