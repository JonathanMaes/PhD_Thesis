...
ASI with out-of-plane \xref{magnetisation} offers particularly convenient electrical interfacing for both input and readout, but its computational capability had yet to be demonstrated. \par % In comparison to in-plane ASI, for which the computational capability had already been demonstrated numerically~\cite{ASI_computation,hon2021numerical}
...
Note that this measures \indexlabel[nolabel]{fading memory}short-term memory; long-term memory often refers to the knowledge engrained in the weights of an ANN, i.e., the \xref{linear readout layer} in the case of RC.
