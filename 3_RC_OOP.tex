...
\sidefig[0.53]{3_RC_OOP/Thermally active/Transformation/magn-magnmin/averaged.pdf}{
	...
	Inverse \xref{mean squared error} $1/\MSE$ of a sine-to-sawtooth signal transformation using a thermally active $11 \times 11$ OOP square-lattice ASI, as a function of the input \link{external magnetic field}{magnetic field} range $B_0 \rightarrow B_1$ at a constant input frequency $f=\SI{100}{\hertz}$.
...
\sidefigs[0.53]{3_RC_OOP/Thermally active/Transformation/grad-magn/freq1/averaged.pdf}{3_RC_OOP/Thermally active/Transformation/grad-magn/freq1/details.pdf}{
	...
	Impact of the \xref{property gradient} $\Gamma$ on the performance of a \SI{1}{\hertz} sine-to-sawtooth signal transformation by an $11 \times 11$ OOP square-lattice ASI \link{reservoir computing}{reservoir}.
...
Unsurprisingly, this limit improves by adding a \link{property gradient}{gradient} and increasing the system size.
...
The smaller ASI without gradient struggles to reproduce the peaks of the desired waveform, as its magnets only respond to a narrow \link{external magnetic field}{field} range.
On the other hand, the larger ASI with an appreciable gradient $\Gamma \approx \SI{25}{\percent}$ contains magnets with various \xref{coercive fields}, enabling it to capture both the peaks and valleys, since these are likely to respectively coincide with low and high input fields.
