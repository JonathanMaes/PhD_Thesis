...
Now, RC metrics can be used to verify this claim: the task-agnostic metrics for a system without defects ($\sigma(\EEA) = 0$) are shown in~\cref{fig:3:Clocking_Sweeps_binary_TA_EBstd0}. \par
