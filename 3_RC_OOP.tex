...
\label{sec:3:OOP_nanomagnet_PMA}\indexlabel[nolabel]{single-domain nanomagnet}
...
% TODO FIG: make own figure of nanomagnets?
...
\paragraph{Input}
Practically, such an input method can be realised through \xref{spin--orbit torque} (SOT) in the presence of a symmetry-breaking in-plane field, as discussed earlier in~\cref{sec:3:IO_exp_to_sim}.
...
% TODO FIG: schematic as in fig. 6a to illustrate column-wise readout?
