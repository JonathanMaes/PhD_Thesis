...
The absence of defects results in a far more orderly domain wall motion than expected in a real system, where domain walls would be likely to remain pinned at defects (i.e., high-anisotropy magnets).
...
Note also that, during the $B$-cycles in~\cref{fig:3:Clocking_clearly_EBstd0}, the central white-coloured domain does not re-grow with the same Petit-Beurre-shape it previously had during the $A$-cycles.
...
This is part of the general phenomenon that, in the two-step AFM clocking protocol, domain growth preferentially occurs at corners. \par
...
% Notably, systems with low $\EMC$ --- which enhances this effect --- are typically easier to fabricate.
