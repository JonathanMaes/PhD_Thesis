...
\subsubsection{Exchange-coupled system} % TODO: expand, could be omitted if not sufficiently worked out. Maybe better to change this to a showcase of the application of multiple inputs in sequence and how this affects the system.
