...
The main factor that attracted attention towards OOP ASI for \xref{reservoir computing} (RC) was that they allow very efficient and relatively simple input and read-out methods to be used.
...
% TODO END: check if this is not partly redundant, given the introduction
