...
\makeshiftfig{
	...
	The \link{external magnetic field}{magnetic field} used in the clocking cycles has a magnitude $B_\mathrm{ext} = \qty{3.78}{\milli\tesla}$.
}
...
\makeshiftfig{
	...
	All magnets are initially magnetised in one of the \xref{antiferromagnetic} ground states (white).
	The \link{external magnetic field}{magnetic field} used in the clocking cycles has a magnitude $B_\mathrm{ext} = \qty{5.5}{\milli\tesla}$.
}
...
\makeshiftfig{
	...
	\textbf{(a)} System with high \xref{magnetostatic coupling} $\EMC = 400 \kBT$, requiring an input magnitude $B_\mathrm{ext} = \qty{11.2}{\milli\tesla}$ for controlled domain wall movement.
