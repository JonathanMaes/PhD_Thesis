...
\begin{enumerate}
	...
	All aforementioned energy contributions are internal to individual OOP magnets, making the \xref{magnetostatic interaction} the sole reason for the AFM ground state of OOP ASI. % E_MS: \lesssim\SI{1.1e-17}{\joule}
...
Such defects could explain why a better \xref{fit quality} $\eta$ could be achieved for $S_\mathrm{ASI} = \SI{25}{nm}$ and \SI{30}{\nano\metre} than for $S_\mathrm{ASI} = \SI{20}{nm}$. \par
...
} $\EEA = \SI{110}{\electronvolt} \pm \SI{5}{\percent}$ and the same \xref{magnetic moment} as the thermally active ASI ($\mu = \SI{2.5e-16}{\ampere\metre\squared}$), which was based on magnets with a diameter $D_\mathrm{NM} = \SI{170}{\nano\metre}$.
