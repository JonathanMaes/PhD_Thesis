...
The last mode allows the user to inspect the spatial distribution of several parameters like the temperature $T$, \xref{shape anisotropy} $\EB$ and size of the magnetic moment $\mu$.
